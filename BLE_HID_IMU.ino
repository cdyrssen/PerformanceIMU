...
// Home coordinates
double ACCEL_X_HOME, ACCEL_Y_HOME, ACCEL_Z_HOME;
double GYRO_X_HOME, GYRO_Y_HOME, GYRO_Z_HOME;
double ORIENT_X_HOME, ORIENT_Y_HOME, ORIENT_Z_HOME;
...
void getEventData(sensors_event_t* event, double* x, double* y, double* z){
